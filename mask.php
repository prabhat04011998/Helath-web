...
<!-- Mirrored from loveseat.templates.editmysite.com/store/p1/Frame.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 May 2020 10:41:05 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head><script src="../../gdpr/gdprscript2170.js?buildTime=1589934640&amp;hasRemindMe=true&amp;stealth=false"></script>
		<title>Masks</title><meta property="og:site_name" content="Loveseat" />
...
<style type='text/css'>#wsite-com-product-images .wsite-imageaspectratio-image-height, .wsite-com-category-product-image-height.wsite-imageaspectratio-image-height, .wsite-product .wsite-imageaspectratio-image-height, .wsite-com-category-product-featured-image-height.wsite-imageaspectratio-image-height { margin-bottom: 100% !important } .wsite-com-category-product-group .wsite-com-column { width: 33.33% !important } .wsite-com-category-product-featured-group .wsite-com-column { width: 25.00% !important } .wsite-com-category-subcategory-group .wsite-com-column { width: 33.33% !important } </style>
		...
		<script src='files/templateArtifactse58b.js'></script>
<script>
...
<script src="js/main8421.js?buildTime=1589934640"></script><script> base_context='Site'; base_name='_W'; ASSETS_BASE='cdn2.editmysite.com'; buildTime='1589934640'</script>
<script>_W = _W || {};
...
<script type="text/javascript" src="../../../cdn2.editmysite.com/js/lang/en/stld2bd.js?buildTime=1589934640&amp;"></script><script> _W.themePlugins = [];</script><script type="text/javascript"> _W.recaptchaUrl = "../../../www.google.com/recaptcha/api.js"; </script><script type="text/javascript"><!--
...
jQuery(document).ready(function($) {
	...
	<body class="no-header-page  wsite-page-store  full-width-body-off header-overlay-on alt-nav-off  wsite-theme-light">
				...
				<div class="wsite-section-content">
					<div class="container">
						<div id='wsite-content' class='wsite-not-footer'>
							<div id="wsite-com-product-gen" data-id="1">
								<input id="wsite-com-product-view-variation-data" type="hidden" value="[{&quot;pickup_location&quot;:null,&quot;site_product_sku_id&quot;:&quot;1&quot;,&quot;price&quot;:25.95,&quot;sale_price&quot;:null,&quot;image_order&quot;:null,&quot;weight&quot;:null,&quot;sku&quot;:null,&quot;fulfillment_options&quot;:[&quot;shipping&quot;],&quot;product_type&quot;:&quot;physical&quot;}]" />
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" id="maskimage1" src="images/products/masks/3-A.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" id="maskimage2" src="images/products/masks/3-B.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" id="maskimage3" src="images/products/masks/3-C.jpg" alt="Third slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" id="maskimage4" src="images/products/masks/3-E.jpg" alt="Third slide">
    </div>
  </div>
...
<span><button class="colorOption" style="background-color: gainsboro;" onclick="whitemask()">&nbsp;</button></span>
<span><button class="colorOption" style="background-color: #6fd6f7;" onclick="bluemask()">&nbsp;</button></span>
<span><button class="colorOption" style="background-color: #e5f558;" onclick="yellowmask()">&nbsp;</button></span>
<span><button class="colorOption" style="background-color: #232526;" onclick="blackmask()">&nbsp;</button></span>
</div>
									</div>
...
These masks helps in fighting Corona virus.</p>
												
												<div id="wsite-com-product-inventory-message"></div>
											</div>
									...
									<div class="clear"></div>
									<div id="wsite-com-product-tab"></div>
								</div>
							</div>
						</div>
					</div>
...
<script type="text/javascript" src="js/custom72c5.js"></script>
  <div id="customer-accounts-app"></div>
	  <script>
	  	function whitemask(){
	  		console.log("re");
	  		$("#maskimage1").attr('src','images/products/masks/3-A.jpg');
	  		$("#maskimage2").attr('src','images/products/masks/3-B.jpg');
	  		$("#maskimage3").attr('src','images/products/masks/3-C.jpg');
	  		$("#maskimage4").attr('src','images/products/masks/3-Page.jpg');

	  	}
	  	function bluemask(){
	  		console.log("blue");
	  		$("#maskimage1").attr('src','images/products/masks/8-A.jpg');
	  		$("#maskimage2").attr('src','images/products/masks/8-B.jpg');
	  		$("#maskimage3").attr('src','images/products/masks/8-C.jpg');
	  		$("#maskimage4").attr('src','images/products/masks/8-Page.jpg');
	  	}
	  	function yellowmask(){
	  		console.log("yellow");
	  		$("#maskimage1").attr('src','images/products/masks/2-A.jpg');
	  		$("#maskimage2").attr('src','images/products/masks/2-B.jpg');
	  		$("#maskimage3").attr('src','images/products/masks/2-C.jpg');
	  		$("#maskimage4").attr('src','images/products/masks/2-Page.jpg');
	  	}
	  	function blackmask(){
	  		console.log("black");
	  		$("#maskimage1").attr('src','images/products/masks/6-A.jpg');
	  		$("#maskimage2").attr('src','images/products/masks/6-B.jpg');
	  		$("#maskimage3").attr('src','images/products/masks/6-C.jpg');
	  		$("#maskimage4").attr('src','images/products/masks/6-Page.jpg');
	  	}
