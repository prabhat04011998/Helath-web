...
<head><script src="gdpr/gdprscript2170.js?buildTime=1589934640&amp;hasRemindMe=true&amp;stealth=false"></script>
		<title>About Us</title><meta property="og:site_name" content="Loveseat" />
...
jQuery(document).ready(function($) {
	...
	<body class="no-header-page  wsite-page-about  full-width-body-off header-overlay-on alt-nav-off  wsite-theme-light">
	...
	<div class="wrapper">
		...
		<div class="main-wrap">
      		<div id="wsite-content" class="wsite-elements wsite-not-footer">
          					...
          					<div class="container">
								<div class="wsite-section-elements">
									...
									<div class="paragraph">
										<span>
											<font color="#626262">
												<p>New Oranie Leaf Private Limited is Manufacturer & Exporter of N-95 mask, PPE kits and non woven shoe cover, swine flu mask, dust mask, Tie mask, disposable mask, ear loop mask, bouffant caps, face mask & surgical mask in Delhi NCR, India.</p>

												<p>New Oranie has in house product testing equipment for N-95 Masks, KN 95 masks, 3 Ply Masks, Swine flu mask, Dust Mask, Tie mask, Disposable mask, Earloop mask complying with NIOSH, CE and ISI Standard		</p>

												<p>At present New Oranie is ISO 9001:2015 certified and also secured GMP (Good Manufacturing Practise) and MDD (Medical Device Directive) from United States of America. Company has left no stone unturned in making their product one of the best in industry and complying with all norms.
													New Oranie has tie up with more than 100+ retail stores and few hospital chains for supplying N95 masks to them. Company will also start exporting to some countries like USA, Africa, UAE, Oman and other Gulf countries.
													Our other range of products are as follows:</p>

												<ul>
													<li>N95 / KN 95 / 3 Ply Masks</li>
													<li>PPE Kit</li>
													<li>Sanitizers</li>
													<li>Sanitization tunnel</li>
												</ul>
											</font>
										</span>
									</div>
				...
				<div class="wsite-section-wrap">
					<div class="wsite-section wsite-body-section wsite-section-bg-color wsite-background-14" style="height: auto;background-color: #ffffff;background-image: none;" >
						<div class="wsite-section-content">
							<div class="container">
								<div class="wsite-section-elements">
												...
												<table class="wsite-multicol-table">
													<tbody class="wsite-multicol-tbody">
														<tr class="wsite-multicol-tr">
															<td class="wsite-multicol-col" style="width:50.606060606061%; padding:0 80px;">
																<div>
																	<div class="wsite-image wsite-image-border-none " style="padding-top:10px;padding-bottom:10px;margin-left:0;margin-right:0;text-align:center">
																		<a>
																			<img src="images/certifications/1.jpg" alt="Picture" style="width:465;max-width:100%" />
																		</a>
																		<div style="display:block;font-size:90%"></div>
																	</div>
																</div>
															</td>
															<td class="wsite-multicol-col" style="width:49.393939393939%; padding:0 80px;">
																<div>
																	<div class="wsite-image wsite-image-border-none " style="padding-top:10px;padding-bottom:10px;margin-left:0;margin-right:0;text-align:center">
																		<a>
																			<img src="images/certifications/2.jpg" alt="Picture" style="width:465;max-width:100%" />
																		</a>
																		<div style="display:block;font-size:90%"></div>
																	</div>
																</div>
														...
														<tr class="wsite-multicol-tr">
															<td class="wsite-multicol-col" style="width:50.606060606061%; padding:0 80px;">
																<div>
																	<div class="wsite-image wsite-image-border-none " style="padding-top:10px;padding-bottom:10px;margin-left:0;margin-right:0;text-align:center">
																		<a>
																			<img src="images/certifications/3.jpg" alt="Picture" style="width:465;max-width:100%" />
																		</a>
																		<div style="display:block;font-size:90%"></div>
																	</div>
																</div>
															...
															<td class="wsite-multicol-col" style="width:49.393939393939%; padding:0 80px;">
																<div>
																	<div class="wsite-image wsite-image-border-none " style="padding-top:10px;padding-bottom:10px;margin-left:0;margin-right:0;text-align:center">
																		<a>
																			<img src="images/certifications/4.jpg" alt="Picture" style="width:465;max-width:100%" />
																		</a>
																		<div style="display:block;font-size:90%"></div>
																	</div>
																</div>
